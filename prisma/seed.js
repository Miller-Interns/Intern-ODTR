...
async function main() {
    ...
    const internsToCreate = [
        {
            userData: { id: 'a1b2c3d4-e5f6-7890-1234-567890abcdef', email: 'test1@mllrdev.com', name: 'Harold Jan P. Besario', password: 'test1', isAdmin: false },
            internData: {
        ...
        {
            userData: { id: 'a1b2c3d4-e5f6-7890-1234-567890abcpop', email: 'test2@mllrdev.com', name: 'Remejie Maano', password: 'test2', isAdmin: false },
            internData: {
                first_name: 'Remejie',
                middle_name: '',
                last_name: 'Maano',
