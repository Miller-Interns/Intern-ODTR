...
import { AddInternResponseSchema, type AddInternResponse } from '~/server/response/crud-for-interns/add_intern/add-intern.response'
import { InternDetailsResponseSchema, type InternDetailsResponse } from '~/server/response/crud-for-interns/interns/intern-details.response'
import type { InternWithUserAndBatchStatus } from '~/server/service/crud-for-interns/interns/intern.service'
