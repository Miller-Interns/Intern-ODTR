			...
			<div v-else-if="activeTimeLog">
				...
				<UCard class="mb-6 shadow-lg">
					...
					<div class="mb-6 space-y-4">
						...
						<div class="light:bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 p-4 text-center">
				...
				<UCard class="shadow-lg">
					...
					<div class="space-y-4">
						...
						<div v-if="lastCompletedLog.intern_notes">
							...
							<p class="light:bg-gray-50 rounded p-2 text-sm">{{ lastCompletedLog.intern_notes }}</p>
						</div>
						<div class="light:bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 p-4 text-center">
