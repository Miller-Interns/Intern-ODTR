			...
			<UCard class="shadow-lg">
				<div class="flex items-start gap-4">
					...
					<div>
						...
						<p class="text-black-500 text-sm">Hours: {{ data.profile.hours_completed?.toFixed(0) }} / {{ data.profile.required_hours }}</p>
					</div>
				</div>
			</UCard>
			...
			>
				...
				<div class="space-y-2 pt-4">
					...
					>
						...
						<template #body>
							<p class="light:text-black py-4">Are you sure you want to log out?</p>
						</template>
						<template #footer>
