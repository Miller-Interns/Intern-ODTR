    ...
    <div class="login-card">
      ...
      <form class="login-form" @submit.prevent="handleLogin">
        ...
        <div class="input-group">
          ...
          <input id="password" v-model="password" name="password" :type="passwordFieldType"
          ...
          <button type="button" class="toggle-password" @click="togglePasswordVisibility">
            <!-- This v-if is now correctly wired -->
            <svg v-if="!isPasswordVisible" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
...
// Make sure you have created the file composables/useAuth.ts
const { user } = useAuth();
