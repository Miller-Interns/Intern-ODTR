              ...
              <template #header>
                <div class="flex justify-between items-center">
                  <div class="flex left gap-3">
                    ...
                    <UBadge class="rounded-full" color=primary variant=solid size="md">{{ capitalize(batch.status) }}
                    </UBadge>
                  </div>
              ...
              <UModal v-model:open="openModal" :dismissible="false">
                ...
                <template #header="{ close }">
                  <div class="flex flex-col items-left text-left p-4">
                    ...
                    <h4 class="mt-2 text-sm text-gray-500 dark:text-gray-400">Are you sure you want to mark all interns
