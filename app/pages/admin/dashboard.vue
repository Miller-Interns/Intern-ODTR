	...
	<UContainer>
		<header class="mb-6 md:mb-8">
			<div class="flex flex-wrap items-start justify-between gap-4">
				<div>
					<div class="flex items-center gap-3">
						...
						<UBadge v-if="!pending" color="primary" variant="solid" size="sm"
			...
			<div class="flex items-center justify-between">
				...
				<UButton icon="i-lucide-check-check" label="Approve All" color="primary" variant="solid"
					:disabled="!pendingLogs || pendingLogs.length === 0 || isApproving" :loading="isApproving"
		...
		<main>
			...
			<UAlert v-else-if="error" icon="i-lucide-triangle-alert" color="error" variant="subtle"
				title="Failed to load data" :description="error.message" />
			...
			<div v-else
				...
				<UIcon name="i-lucide-circle-check" class="mx-auto h-12 w-12 text-gray-400 dark:text-gray-500" />
